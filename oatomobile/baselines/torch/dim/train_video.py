...
flags.DEFINE_string(
    name="train_episodes_file",
    default=None,
    help="List of training episodes",
)
flags.DEFINE_string(
    name="val_episodes_file",
    default=None,
    help="List of validation episodes",
)
flags.DEFINE_string(
    name="output_dir",
    default=None,
...
def main(argv):
    ...
    train_episodes_file = FLAGS.train_episodes_file
    val_episodes_file = FLAGS.val_episodes_file
    ...
    dataset_train = CARLADataset.as_torch_form_video(
        dataset_dir=dataset_dir,
        episode_list_file=train_episodes_file,
    ...
    dataset_val = CARLADataset.as_torch_form_video(
        dataset_dir=dataset_dir,
        episode_list_file=val_episodes_file,
        modalities=modalities,
    )
    ...
    def train_step(
        ...
        y = torch.normal(  # pylint: disable=no-member
            ...
            std=torch.ones_like(batch["player_future"][..., :2])
...
if __name__ == "__main__":
    ...
    flags.mark_flag_as_required("train_episodes_file")
    flags.mark_flag_as_required("val_episodes_file")
