...
def generate_dataset(town, num_pedestrians, num_vehicles,
                     num_steps, destination):
...
if __name__ == '__main__':
  ...
  generate_dataset(args.town, args.pedestrians, args.vehicles,
                   args.steps, args.destination)
